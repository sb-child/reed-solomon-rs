...
#[derive(Debug)]
pub struct Encoder<const ECCLEN: usize> {
    generator: Polynom,
}

impl<const ECCLEN: usize> Encoder<ECCLEN> {
    ...
    pub fn new() -> Self {
        Encoder {
            generator: generator_poly::<ECCLEN>(),
        }
    }
...
fn generator_poly<const LEN: usize>() -> Polynom {
...
mod tests {
    ...
    fn generator_poly() {
        let answers = [
            ...
            polynom![
                1, 116, 64, 52, 174, 54, 126, 16, 194, 162, 33, 33, 157, 176, 197, 225, 12, 59, 55,
                253, 228, 148, 47, 179, 185, 24, 138, 253, 20, 142, 55, 172, 88
            ],
            polynom![
                1, 193, 10, 255, 58, 128, 183, 115, 140, 153, 147, 91, 197, 219, 221, 220, 142, 28,
                120, 21, 164, 147, 6, 204, 40, 230, 182, 14, 121, 48, 143, 77, 228, 81, 85, 43,
                162, 16, 195, 163, 35, 149, 154, 35, 132, 100, 100, 51, 176, 11, 161, 134, 208,
                132, 244, 176, 192, 221, 232, 171, 125, 155, 228, 242, 245
            ],
        ];
