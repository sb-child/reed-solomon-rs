...
pub fn mul(x: u8, y: u8) -> u8 {
    if x == 0 || y == 0 {
        ...
        let exp_index = log_x as usize + log_y as usize;
...
pub fn pow(x: u8, power: i32) -> u8 {
    let mut i = uncheck!(LOG[x as usize]) as i32 * power % 255;
...
mod tests {
    ...
    fn pow() {
        let answers: [u8; LOG_SIZE] = [
            1, 1, 1, 19, 76, 254, 223, 211, 239, 59, 172, 29, 226, 145, 112, 123, 73, 185, 89, 185,
            89, 134, 15, 101, 106, 169, 182, 237, 62, 168, 64, 7, 28, 125, 64, 80, 243, 15, 169,
            241, 80, 11, 137, 79, 220, 158, 196, 214, 5, 38, 253, 169, 156, 193, 156, 145, 134,
            102, 89, 185, 5, 245, 44, 219, 255, 150, 53, 199, 146, 146, 227, 108, 230, 147, 127,
            38, 59, 89, 169, 44, 205, 242, 31, 68, 45, 38, 86, 202, 231, 38, 222, 165, 74, 237, 47,
            231, 123, 17, 206, 162, 68, 78, 79, 10, 101, 251, 83, 211, 128, 138, 64, 70, 139, 46,
            50, 113, 146, 205, 31, 179, 69, 27, 13, 233, 53, 146, 1, 10, 47, 93, 170, 75, 163, 71,
            225, 203, 180, 203, 64, 101, 219, 39, 102, 186, 125, 200, 152, 243, 89, 61, 215, 215,
            230, 68, 10, 251, 64, 193, 12, 230, 172, 19, 170, 196, 138, 226, 7, 139, 107, 123, 132,
            48, 10, 45, 103, 1, 228, 117, 173, 223, 85, 202, 109, 60, 167, 114, 103, 55, 150, 217,
            107, 94, 114, 100, 160, 103, 235, 12, 201, 198, 143, 107, 50, 119, 68, 241, 43, 183,
            26, 64, 36, 240, 130, 113, 59, 218, 44, 185, 219, 2, 216, 182, 219, 179, 252, 145, 45,
            252, 226, 85, 230, 239, 79, 39, 95, 77, 60, 62, 223, 215, 147, 77, 91, 3, 172, 8, 168,
            63, 38, 1, 26, 191, 219, 58, 20, 175,
        ];
